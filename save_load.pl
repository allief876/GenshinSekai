load(Filename):-
	...
	retract(player_equipment(Equipment)),
	retract(player_inventory(Inventory)),
	retract(player_gold(Gold)),
	retract(player_progress(A,B,C,D,E)),
	...
	asserta(player_equipment(New_Equipment)),
	asserta(player_inventory(New_Inventory)),
	asserta(player_gold(New_Gold)),
	asserta(player_progress(New_A,New_B,New_C,New_D,New_E)),
